...
for line in inf:
    ...
    vcf_output = "./gene/" + str(li[0]) + ".pro.vcf.gz"
    ...
    pi_command = "vcftools --vcf " + str(vcf_output) + ".output --window-pi " + str(windows_size) + " --window-pi-step " + str(windows_size) + " --out ./pi/" + str(li[0]) + ".pro.pi"
